...
class TestQuery:
    ...
    @patch.object(HttpSyncBackend, "request")
    def test_query_with_context_schema_probe_form_encode(self, mock_raw_request):
    ...
    @patch.object(HttpSyncBackend, "request")
    def test_query_with_context_schema_probe_external_data(self, mock_raw_request):
